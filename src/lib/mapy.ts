...
// P0 hardening (Sprint 1.2 / v1.7.4): no hardcoded API key fallback.
// The previously-committed Mapy key MUST be rotated in the Mapy console — see docs/SECRETS_ROTATION.md.
