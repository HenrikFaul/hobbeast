...
const AdminOrgVerification = lazy(() => import("@/components/admin/AdminOrgVerification").then((m) => ({ default: m.AdminOrgVerification })));
...
const Admin = () => {
  ...
  const allowedTabs = ['catalog', 'users', 'auto-events', 'events', 'operations', 'moderation', 'metrics', 'outcomes', 'feature-flags', 'eventbrite', 'common-admin', 'scraper', 'partners', 'clubs', 'club-refresh', 'post-import', 'community', 'org-verify'] as const;
