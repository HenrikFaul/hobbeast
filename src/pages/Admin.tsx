...
const Admin = () => {
  ...
  const allowedTabs = ['catalog', 'users', 'auto-events', 'events', 'operations', 'moderation', 'metrics', 'outcomes', 'feature-flags', 'eventbrite', 'common-admin', 'scraper', 'partners', 'clubs', 'club-refresh'] as const;
