  ...
  try {
    ...
    if (action === 'suggest-rule') {
      ...
      const prompt = [
        ...
        '[attr*=v], descendant (space) and child (>) combinators, and :nth-of-type(N) with a plain integer.',
        'No other pseudo-classes: no :has, no :not, no :nth-child, no 2n+1 formulas.',
