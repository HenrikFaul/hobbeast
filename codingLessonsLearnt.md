...
## ➕ APPEND — 2026-04-03 common_admin drift (Hobbeast-specifikus)
...
- **Hibaüzenet**: Az egyik app adminja tud valamit, a másik nem; a capability más helyre kerül és elveszik a közös modell.
- **Gyökérok**: Nem volt közös, kanonikus common_admin modell; az admin képességek apponként elsodródtak.
- **Javítás**: A common_admin capability-k governance kanonikus forrásra lettek kötve; a Hobbeast admin új Common Admin tabot kapott, az Import funkciók megmaradtak.
