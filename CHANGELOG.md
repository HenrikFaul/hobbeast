...
Chrome/120 Safari/537.36 HobbeastBot/1.0 (+https://expericentre.com; event aggregation)
```
...
| | Eredmény |
| --- | --- |
| **B** (Chrome + a mi tokenünk) vs a mai UA | **30 hoszton bitre azonos** |
| HTTP-státusz változás B alatt | **0** |
| **C** (csak a bot-token, Chrome nélkül) | 2 hoszton csökken a tartalom |
...
| Forrás | Előtte | Utána |
| --- | ---: | ---: |
| Magiczny Kraków | 0 | **20** |
| Innsbruck Tourismus | 0 | **12** |
| Filharmonia Narodowa | 0 | **11** |
| Cankarjev dom | 0 | **1** |
...
### A grepsearch crawler technikáiból hat átemelve — és egy őszinte mérleg
...
| Ország | Források |
|---|---|
| 🇦🇹 AT | events.at, Linz-Termine, Musikverein Wien, Wiener Staatsoper, WienTourismus\* |
| 🇨🇿 CZ | Prague City Tourism, Rudolfinum, Ticketmaster ČR |
| 🇵🇱 PL | Miasto Poznań (MIM), Teatr Wielki – Opera Narodowa, Ticketmaster Polska, wroclaw.pl (Go Wrocław), Go2Warsaw |
| 🇸🇮 SI | Kultura Maribor, Mojekarte.si, Turizem Ljubljana |
| 🇸🇰 SK | Kam do mesta, Slovenské národné divadlo, Predpredaj.sk, Visit Bratislava |
...
[`docs/releases/MIGRATION_RECORD_v1.57.0_foreign_event_sources_v7.md`](./docs/releases/MIGRATION_RECORD_v1.57.0_foreign_event_sources_v7.md).
...
| Crawl-delay | részletoldal / futás | falióra |
|---|---|---|
| 2 s (Graz) | 40 | 80 s |
| 20 s (jegy.hu) | 12 | 240 s |
| 600 s (prague.eu) | **0 — csak listaoldal** | 0 s |
